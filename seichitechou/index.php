                            ...
                            for(var i = i_limit; i <= n.length; i++){
                                if(content[i] != undefined && content[i] != "" && load_count < 30){
                                    ...
                                    div_element.innerHTML = 
                                        '<div style="border-style: solid ; border-width: 1px; border-color: #f2f2f2; background-color: white;"><p><a style="color: #000000; font-weight:bold;" href="search_result_map_view.php?user_name=' + user_name[i] + '&path_name=&id=' + n[i] + '"; return false;>' + user_name[i] + '</a> <span style="color: #a1a1a1;">(<a style="color: #a1a1a1;" href="search_result_map.html?user_name=&path_name=' + path_name[i] + '&id=' + n[i] + '"; return false;>' + path_name[i] + '</a>)</span>&nbsp;&nbsp;' + created_at[i] + '<br>' + contentStr[i] + '<div style="text-align:center;">「' + content[i] + '」</div><span style="float:left;"><a onclick="like_button(' + n[i] + ')">いいね！</a>' + likes[i] + '件</span><span style="float:right;"><a style="font-size:10px; color:#a1a1a1;" onclick="delete_button(' + n[i] + ')">削除&nbsp;</a></span><br></p></div>';
